        ...
        <div class="min-[320px]:p-0 min-[320px]:m-0 lg:container mx-auto">
          <div class="min-[320px]:m-0 sm:m-2 md:m-4 lg:m-8 bg-white">
            <div class="min-[320px]:p-2 sm:m-0 md:m-2 lg:p-4">
                <h2 class="min-[320px]:text-xl min-[320px]:mt-3 sm:text-xl md:text-2xl font-semibold lg:text-3xl flex mr-2">Dữ liệu khách hàng 
                    </h2>
                    <div class="my-3">
                        <div class="min-[320px]:block sm:flex sm:justify-between md:flex md:justify-between lg:flex lg:justify-between">
                            <div class="flex">
                                        ...
                                        <div class="relative">
                                            <div
                                                ...
                                                <svg aria-hidden="true"
                                                    class="w-5 h-5 text-sm text-gray-500 dark:text-gray-400" fill="none"
                                            ...
                                            <input type="search" id="default-search" name="search" data-toggle="hideseek"
                                                ...
                                                placeholder="Tìm kiếm số điện thoại, địa chỉ" required />
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="">
                                <button class="min-[320px]:mt-3 sm:mt-0 md:mt-0 lg:mt-0 bg-gray-200 border px-3 py-2 rounded-lg text-black" data-toggle="modal"
                                    data-target="#exampleModal">
                                    <font-awesome-icon :icon="['fas', 'download']" class="mr-3" />xuất file CSV
                                </button>
                            </div>
                        </div>
                        <div class="my-4">

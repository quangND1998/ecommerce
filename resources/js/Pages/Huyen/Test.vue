      ...
      <div class="min-[320px]:block sm:block md:block lg:grid lg:gap-4 lg:grid-cols-2 my-4">
        ...
        <div class="p-2 rounded-lg col-md-12">
          <div class="panel panel-default">
            ...
            <div >
                <div class="grid grid-cols-5 gap-4 text-xs text-white uppercase bg-gray-600 dark:bg-gray-700 px-3 py-4 dark:text-gray-400">
                    <div>
                        <p>Mã đơn hàng</p>
                    </div>
                    <div>
                ...
                <div data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
                    <div class="grid grid-cols-5 gap-4 text-sm px-3 py-3 dark:text-gray-400">
                        <div>
                            <a ><font-awesome-icon :icon="['fas', 'chevron-down']" class="mr-2"/>DH - 1345</a>
                        </div>
                        <div>
                            <p>Nguyễn A</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 bg-gray-300 p-3 border rounded-lg accordian-body collapse" id="demo1"  >
                      <div class="my-3 rounded-lg border">
                        ...
                        <div class="grid grid-cols-4 gap-4  bg-white py-3 px-3">
                          <div class="block">
                            ...
                            <div
                              class="item_information p-2 bg-gray-100 rounded-lg"
                            >
                      ...
                      <table class="table table-striped w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg" >
                        ...
                        <tbody>
                          <tr  data-toggle="collapse" class="accordion-toggle bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" data-target="#demo10">
                ...
                <div data-toggle="collapse" data-target="#demo2" class="accordion-toggle">
                    <div class="grid grid-cols-5 gap-4 text-sm px-3 py-3 dark:text-gray-400">
                        <div>
                            <a ><font-awesome-icon :icon="['fas', 'chevron-down']" class="mr-2"/>DH - 1345</a>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 bg-gray-300 p-3 border rounded-lg accordian-body collapse" id="demo2"  >
                      <div class="my-3 rounded-lg border">
                        <div class="title_information p-2">
                          <h3>Thông tin khách hàng</h3>
                        </div>
...
export default {
  ...
  mounted: function () {
    ...
    $(".item_crud").click(function (e) {
      ...
      $(this).next(".list_icon_crud").slideToggle();
    });
  },
  methods: {},
};

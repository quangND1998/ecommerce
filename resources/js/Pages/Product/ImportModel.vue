    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content rounded-lg">
        <div class="modal-header">
          <h5 class="modal-title text-lg font-semibold" id="exampleModalLabel">Import Excel</h5>
          <!-- <h5
            v-else
        ...
        <div class="modal-body">
          <form @submit.prevent="save">
            ...
            <div>
              <div class="text-center my-3" :class="errors.product_file ? 'border-red-500' : ''">
                <div class="flex items-center justify-center w-full">
                  ...
                  >
                    ...
                    />
                    {{form.product_file !==null ? form.product_file.name:'' }}
                  </label>
                </div>
              </div>
              <div class="text-red-500" v-if="errors.product_file">{{ errors.product_file }}</div>
            </div>
            <hr />
...
export default {
  ...
  methods: {
    save() {
      ...
      this.form.post(route("warehouse.importProduct"), {
        preserveState: true,
        onError: errors => {

          ...
          <div class="p-4">
            <div class="my-3 flex">
              ...
              <div class="block">
                ...
                <h2 class="font-semibold text-3xl flex mr-2">Chỉnh sửa bài viết </h2>
              </div>
            </div>
            ...
            <div class="my-5">
              ...
              <div class="bg-white border rounded-md p-3">
                ...
                <img v-else-if="post.image" :src="post.image" alt />
              </div>
            </div>
            <div class="my-5">
...
export default {
  ...
  data() {
    return {
      ...
      form: this.$inertia.form({
        name: this.post.name,
        tags: this.multipleSelect(this.post.tags),
  ...
  methods: {
    save() {
      this.form.post(route("post.update", this.post.id), {
        preserveState: true,
        onError: errors => {
